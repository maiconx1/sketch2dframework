...
public class Poligono extends Figura
{
    ...
    private boolean poligonoAberto=false;
    ...
    public Poligono(Activity activity, ArrayList<Point> pontos, boolean editavel,boolean poligonoAberto)
    {
        super(activity, pontos, editavel);
        setPoligonoAberto(poligonoAberto);
    }
    public Poligono(Activity activity, ArrayList<Point> pontos, boolean editavel, Configuracoes configuracoes,boolean poligonoAberto)
    {
        super(activity, pontos, editavel, configuracoes);
        setPoligonoAberto(poligonoAberto);
    }
    ...
    private boolean isPoligonoAberto() {
        return poligonoAberto;
    }
    private void setPoligonoAberto(boolean poligonoAberto) {
        this.poligonoAberto = poligonoAberto;
    }
